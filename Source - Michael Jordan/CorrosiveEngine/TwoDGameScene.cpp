...
bool TwoDGameScene::Initialise()
{
	...
	//Entity
	//Packet One
	m_pPlayerCam = new EntityCamera(Camera::CamType::Orthographic);
	m_pPlayerCam->SetView(glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	//m_pPlayerCam->SetWorldScale(glm::vec3(Renderer::SCREEN_WIDTH / 2 , Renderer::SCREEN_HEIGHT / 2, 1.0f));
...
void TwoDGameScene::PreLoad()
{
	...
	//LoadLights
	//LoadManager::GetInstance().AddPointLightLoad(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f));
...
//	Return: n/a		|
//
void TwoDGameScene::ProcessWave(float dt)
{
...
//	Return: n/a		|
//
void TwoDGameScene::HandlePlayerOutOfBounds()
{
