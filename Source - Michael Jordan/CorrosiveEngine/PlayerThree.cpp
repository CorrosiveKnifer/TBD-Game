...
//Constructor
PlayerThree::PlayerThree(Camera* cam)
{
...
//	Return: n/a		|
//
void PlayerThree::Draw(Camera* camera, Program* program)
{
...
//	Return: n/a		|
//
void PlayerThree::Process(float dT)
{
...
void PlayerThree::ProcessInput(float dt)
{
...
//	Return: n/a		|
//
void PlayerThree::ProcessDestruction(float dT)
{
	//Process explosion
	if (m_isDestroyed)
	{
...
//	Return: n/a		|
//	
void PlayerThree::HandleDamage(float damage)
{
	m_health -= damage;
...
//	Return: n/a		|
//	
void PlayerThree::Respawn(glm::vec3 pos)
{
	m_isDestroyed = false;
	m_isFalling = false;
	m_health = 100.0f;
